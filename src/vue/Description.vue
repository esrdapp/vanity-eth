<template>
    <div class="panel">
        <p>
            Vanity-HPB is an open source tool using your web browser to generate HPB vanity addresses.<br>
        ...
        <p>
            ...
            <a href="https://github.com/esrdapp/vanity-eth" target="_blank">Github</a>. You can review it as much as you want before using it<br>
            <br>
        ...
        <h2>Performance</h2>
        <p>
            Chrome provides the best results.<br>
            Using Vanity-HPB on your phone or tablet will work, but don't expect to reach the speed of a good old computer.
        </p>
        <h2>Compatibility</h2>
        <p>
            Any address generated with Vanity-HPB is HRC-20 and ERC-20 compatible, which means you can use it for an ICO, an
